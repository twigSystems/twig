...
async def processar_periodo(call_or_message, loja, periodo, inicio=None, fim=None):
    ...
    try:
        ...
        resposta += "\n**Top Produtos (Qtd):** 🛒\n\n"
        for produto, quantidade in resultados_atuais['top_produtos']:
        ...
        # Tente enviar a mensagem sem parse_mode
        try:
            await bot.send_message(chat_id, resposta)
        except Exception as e:
            print(f"Erro ao enviar mensagem sem parse_mode: {str(e)}")
        
        # Agora tente enviar com parse_mode Markdown
        try:
            await bot.send_message(chat_id, resposta, parse_mode='Markdown')
        except Exception as e:
            print(f"Erro ao enviar mensagem com parse_mode Markdown: {str(e)}")
