...
def solicitar_data_hora(mensagem):
    # Função para solicitar data e hora ao usuário
    while True:
        ...
        try:
            ...
            print("Formato inválido! Por favor, insira a data e hora no formato 'AAAA-MM-DD HH:MM:SS'.")
...
def main():
    ...
    data_inicio = solicitar_data_hora("Insira a data e hora de início (formato: 'AAAA-MM-DD HH:MM:SS'): ")
    data_fim = solicitar_data_hora("Insira a data e hora de fim (formato: 'AAAA-MM-DD HH:MM:SS'): ")
